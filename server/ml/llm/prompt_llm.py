...
SYSTEM_PROMPT = (
    ...
    "- add_instrument -> params:{instrument} in {vocals/drums/bass/guitar/keys/strings/other}, {groove} in {default, four_on_floor, funky, swing, half_time, double_time}, {target_bpm}\n"
    "- combine -> params:{instruments} (list of 2+, e.g. [drums, bass]) + {groove}\n"
    ...
    "- style -> params:{style} in {house, tropical, edm, lofi} + {groove} (DSP preset, not generative)\n"
    "- unknown -> params:{}\n"
