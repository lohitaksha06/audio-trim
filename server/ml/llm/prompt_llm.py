...
SYSTEM_PROMPT = (
    ...
    "- enhance_vocals -> params:{denoise, clarity} (clearer voices, remove hiss/noise)\n"
    "- style -> params:{style} in {house, deep_house, techno, trance, trap, dnb, hardstyle, phonk, synthwave, tropical, edm, futuristic, dubstep, lofi} + {groove} (DSP preset, not generative)\n"
