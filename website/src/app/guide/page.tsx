...
const GROOVES = ["default", "four_on_floor", "funky", "swing", "half_time", "double_time"];
const STYLES = ["house", "tropical", "edm", "lofi", "acoustic"];
      ...
      <div className="pt-14 sm:pt-16 flex-1">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
          ...
          <p className="mt-2 text-sm sm:text-base text-white/40">
            Everything below is real and tested — 49-prompt benchmark, 100% NLU accuracy.
            Click any prompt to copy it, then paste it in the <Link href="/prompt" className="text-neon-blue hover:underline">Editor</Link>.
          </p>
